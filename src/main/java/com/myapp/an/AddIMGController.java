...
public class AddIMGController extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        RequestDispatcher requestDispatcher = req.getRequestDispatcher("/WEB-INF/viewsx/namtest/themanh.jsp");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            Product pro = new Product(30, filename, id, id, motaa, 30, name);

             //3. Ket noi csdl
        Connection conn = MySQLConnection.getMySQLConnection();
        //4. them doi tuong Product vao CSDL
        boolean success = DBCrud.addProduct(conn, pro);
